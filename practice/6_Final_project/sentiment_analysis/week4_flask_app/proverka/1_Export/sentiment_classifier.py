...
class SentimentClassifier(object):
    def __init__(self):
        with open('./model.p', 'rb') as pickle_file1:
    	    self.model = pickle.load(pickle_file1)
        with open('./vectorizer.p', 'rb') as pickle_file2:
    	    self.vectorizer = pickle.load(pickle_file2)
